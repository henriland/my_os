...
; floppy for KERNEL.BIN (the MyOS kernel), loads it and executes it.
...
OEMLabel		db "MYBOOT  "			; Disk label. Must be 8 chars!
...
VolumeLabel			db "MYOS       "	; Volume Label: Must be 11 chars!
...
; STRINGS AND VARIABLES
	...
	kern_filename	db "KERNEL  BIN"							; MyOS kernel filename
