...
; and are used in programs/mydev.inc so that an external program can
; use a MyOS system call without having to know its exact position
...
os_main:
	...
	mov es, ax			; segments ever again, as MyOS and its programs
...
option_screen:
	...
	os_init_msg		db 'Welcome to MyOS', 0
	os_version_msg		db 'Version ', MYOS_VER, 0

	dialog_string_1		db 'Thanks for trying out MyOS!', 0
...
not_bas_extension:
	...
	kerndlg_string_1	db 'Cannot load and execute MyOS kernel!', 0
	kerndlg_string_2	db 'KERNEL.BIN is the core of MyOS, and', 0
